  ...
  return (
    <div className='bg-ttymi-green flex flex-col items-center min-h-[70vh]'>
      <Image
        ...
        fill
      />
      <div className='bg-white text-black rounded-t-[2rem] p-32 w-[90vw] mt-[25rem] max-[960px]:mt-[3rem] overflow-x-hidden z-10 flex flex-col items-start max-[1300px]:p-16 max-[650px]:p-6'>
        <div className='flex flex-row'>
          ...
          <div className='flex flex-col'>
            <h1 className='text-xl md:text-3xl font-semibold mb-4'>JÄSENEKSI?</h1>
            <p className='text-base md:text-xl leading-relaxed font-normal max-w-[95%]'>
        ...
        <div className='flex flex-col mt-8'>
          <h3 className='text-lg md:text-2xl font-semibold mb-4'>Jäsenkriteerit:</h3>
          <ul className='list-disc list-outside pl-6 mr-8'>
            <li className='text-base md:text-xl leading-relaxed font-normal max-w-[95%]'>
          ...
          <h3 className='text-lg md:text-2xl font-semibold mb-4 mt-8'>
          ...
          <p className='text-base md:text-xl leading-relaxed font-normal max-w-[95%] mt-8'>
          ...
          <h3 className='text-lg md:text-2xl font-semibold mb-4 mt-8'>Hakulomake (auki 24/7/365)</h3>
          <p className='text-base md:text-xl leading-relaxed font-normal max-w-[95%]'>
            Voit jättää hakemuksen tämän lomakkeen kautta (vaatii kirjautumisen Google-tilillä):
            <br />
            <a
              className='text-base md:text-xl leading-relaxed font-semibold text-ttymi-green no-underline break-all'
          ...
          <h3 className='text-lg md:text-2xl font-semibold mb-4 mt-8'>Lisätietoa</h3>
          <p className='text-base md:text-xl leading-relaxed font-normal max-w-[95%]'>
