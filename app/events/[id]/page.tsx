    ...
    <div className='min-h-[calc(100vh-7rem)] bg-white text-black'>
      <div className='flex flex-row min-h-full max-[1300px]:mt-32 max-[1300px]:flex-col max-[768px]:mt-16'>
        ...
        <div className='m-[5rem_5rem_3rem_1rem] max-[1300px]:m-[2rem_1rem]'>
          <h1 className='text-3xl md:text-[3.5rem] font-semibold p-0 m-0'>{event?.title}</h1>
          <div className='flex flex-row items-center m-0 p-0 my-8 flex-wrap gap-y-4'>
            <div className='flex items-center'>
              <Calendar1 className='w-6 h-6 text-ttymi-green' />
              <p className='text-lg md:text-[1.75rem] font-semibold m-[0_1.5rem_0_0.5rem]'>
                {date.toLocaleDateString('fi-FI', {})}
              </p>
            </div>
            <div className='flex items-center'>
              <Clock className='w-6 h-6 text-ttymi-green' />
              <p className='text-lg md:text-[1.75rem] font-semibold m-[0_1.5rem_0_0.5rem]'>
          ...
          <p className='text-base md:text-2xl font-medium leading-[1.45] whitespace-pre-wrap break-words'>
            {event?.content}
          </p>
        </div>
      </div>
